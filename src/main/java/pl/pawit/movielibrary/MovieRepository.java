...
public class MovieRepository {
    ...
    public List<Movie> getAll() {
        List<Movie> query = jdbcTemplate.query("SELECT id,name,rating FROM movie", BeanPropertyRowMapper.newInstance(Movie.class));
        return query;
    }
    ...
    public int delete(int id) {
        int deletedMovie = jdbcTemplate.update("DELETE FROM movie WHERE id=?", id);
        return deletedMovie;
    }
}
